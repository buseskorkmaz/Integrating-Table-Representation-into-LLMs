...
def main(model_name):
    ...
    train_cfg = {
        "save_checkpoint_dir": os.path.join(file_path, '../../models/wikitable-scigen-mrs_sqa-table-1e-6'),
        "use_wandb" : "true",
    ...
    dataset_path = os.path.join(file_path, '../../data/t5_compliant_hf_train_large')
    ...
    new_model =  os.path.join(file_path, "../../models/flan-t5-xl-msr_sqa-1e-6")
